    ...
    <div class="app-container" v-loading="loading">
        ...
        <el-row class="first">
            ...
            <el-col :span="3" style="height:100%" class="center">
                    <el-button  disabled type="primary" v-show="getStatus==2" >审核中
                    </el-button>
                <el-button type="primary" v-show="getStatus!=2" @click="getService">{{ getStatus == 0 || getStatus == 3? '获取' : '使用' }}
                </el-button>
            </el-col>
        </el-row>
        <el-row class="second">
    ...
    methods: {
        ...
        fetchUserStatus() {
            ...
            showUserServiceStatus(data).then(res => {
                ...
                // console.log(`output->`, this.getStatus)
            })
        },
        getService() {
