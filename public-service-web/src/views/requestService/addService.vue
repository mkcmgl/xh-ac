                ...
                <el-row style="margin-top:5px">
                    <el-col :span="8">
                        <el-form-item label="排序" prop="sort">
                            <el-input-number v-model="form.sort" :min="1" :max="99999" label="排序"
...
import { addService, updateService } from '@/api/access/access.js'
            ...
            this.$refs.form.validate((valid) => {
                if (valid) {
                    ...
                    if (this.creatFlag) {
                        ...
                        updateService(formData).then(res => {
                            if (res.code == 200) {
                                this.btnLoading = false
                                this.$router.push({
                                    path: '/requestService/list'
