<template>
    <div class="app-container" v-loading="loading">
        <el-button type="primary" v-if="dataInfo.reviewStatus == 2" style="float:right" @click="toEdit">编辑</el-button>
        <div class="title">
            <span class="lastRouter" @click="toLast">接入服务</span>
        ...
        <el-row class="second">
            ...
            <el-col :offset="1" :span="5" class="introduceElse" style="padding-bottom:10px ;">
                <el-row>
        ...
        fetchData() {
            ...
            ServiceDetail(data).then(res => {
                if (res.code == 200) {
                    ...
                    // console.log(`output->dataInfo`, this.dataInfo)
