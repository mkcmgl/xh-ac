    ...
    <div class="app-container">
        ...
        <el-row class="tableBg1">
            <el-table :data="tableList" v-loading="loading" ref="tableList" min-height="550px"
                ...
                <el-table-column label="服务创建时间" prop="createDate" :show-overflow-tooltip="true"></el-table-column>
                <el-table-column label="最近更新时间" prop="updateDate" :show-overflow-tooltip="true"></el-table-column>
                <el-table-column label="操作" :show-overflow-tooltip="true">
                    <template slot-scope="scope">
                        <span class="toOther mr10" @click="toDetail(scope.row)">详情</span>
                        <span class="toOther" @click="toEdit(scope.row)">编辑</span>
                    </template>
                </el-table-column>
            </el-table>
        </el-row>
...
<script>
import { serviceList } from "@/api/manageService/manageService.js"
