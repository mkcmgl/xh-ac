...
<script>
import { ServiceDetail, getService, showUserServiceStatus, review,showUserServiceDetail } from "@/api/publicService/publicService.js"
...
export default {
    ...
    created() {
        if (this.$route.query) {
            ...
            this.authData.userId = this.$route.query.userId
    ...
    methods: {
        fetchData() {
            ...
            this.loading=true
            showUserServiceDetail(data).then(res => {
                if (res.code == 200) {
