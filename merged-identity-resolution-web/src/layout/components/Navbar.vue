...
import {redirectPublic,redirectOp} from '@/api/login.js'
export default {
  components: {
    Breadcrumb,
    TopNav,
    ...
    async logout() {
      ...
      this.$confirm('确定注销并退出系统吗？', '提示', {
        ...
        this.$store.dispatch('LogOut').then(() => {
          let url=process.env.NODE_ENV === "production" ?  'http://10.221.19.217/baas/account-center/login' : 'http://192.168.0.106:80/baas/account-center/login'
