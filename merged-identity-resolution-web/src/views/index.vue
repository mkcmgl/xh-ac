  ...
  <div class="app-container home">
    ...
    <div class="warp">
      <div class="left">
        <div class="leftWarp">
          ...
          <div class="leftBottom">
            <div class="leftBottom1">
              ...
              <span class="textNum1">{{ childLinkNum ? childLinkNum : '暂无数据' }}</span>
              <span class="text2 text">公共服务接入数</span>
              <span class="textNum2">{{ publicServiceLinkNum ? publicServiceLinkNum : '暂无数据' }}</span>
        ...
        <div class="leftWarp" v-if="checkRole(['common', 'person', 'organization'])">
          ...
          <div class="leftBottom">
            <div class="leftBottom1">
              ...
              <span class="textNum1">{{ registerTotalNum ? registerTotalNum : '暂无数据' }}</span>
              <span class="text2 text">标识解析量</span>
              <span class="textNum2">{{ resolveTotalNum ? resolveTotalNum : '暂无数据' }}</span>
              <span class="lines"></span>
            </div>
        ...
        <div class="leftWarp hasPic" v-if="checkRole(['common', 'person', 'organization'])">
          <div class="leftTopItem">
            <div class="leftTopTitle">
              公共服务管理平台
            </div>
        ...
        <div class="leftWarp survice" v-if="checkRole(['backbone'])">
          ...
          <div class="surviceLeftBottom">
            <div class="surviceLeftBottomItem">
          ...
          <el-button type="" class="enterBtn">立即进入</el-button>
        </div>
      </div>
      <div class="right">
    ...
    <el-dialog title="选择方式" :visible.sync="creatShow" width="28%" :before-close="handleClose" top="33vh"
      ...
      <div class="creatWarp" style="margin-bottom:15px" @click="creatDid">
        ...
        <div class="content">
          ...
          <p class="describe">创建基于该星火·链网骨干节点的数字身份</p>
        </div>
        <div class="right">
      ...
      <div class="creatWarp" @click="importDid">
        ...
        <div class="content">
          ...
          <p class="describe">已有基于该星火·链网骨干节点的数字身份，通过导入私钥、Keystore恢复数字身份</p>
        </div>
        <div class="right">
            <i class="el-icon-arrow-right"></i>
        </div>
...
<script>
// import {redirect} from "@/api/enterOther/enterOther.js"
